...
export default function GardenerLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      // Demo credentials
      if (email === "gardener@rawda.com" && password === "gardener123") {
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            ...
            <div className="bg-gray-50 rounded-lg p-3 text-xs font-mono text-gray-700">
              <p>Email: <span className="font-semibold">gardener@rawda.com</span></p>
              <p>Password: <span className="font-semibold">gardener123</span></p>
            </div>
          </div>
