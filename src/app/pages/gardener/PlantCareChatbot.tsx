...
export default function PlantCareChatbot() {
  ...
  const getBotResponse = (question: string): string => {
    ...
    if (lowerQuestion.includes("water")) {
      ...
      return "Light requirements vary by plant. Most houseplants prefer bright, indirect light. Direct sunlight can scorch leaves, while too little light causes leggy growth. Observe your plant's response and adjust!";
    } else {
