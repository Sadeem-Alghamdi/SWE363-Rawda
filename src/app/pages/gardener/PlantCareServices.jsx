...
import { ArrowLeft, MapPin, Star, DollarSign, Phone, Calendar, Clock, Plus, Minus } from "lucide-react";
...
export default function PlantCareServices() {
  const [step, setStep] = useState<"location" | "stores" | "booking" | "confirmation">("location");
  ...
  const stores: Store[] = [
    {
      id: "1",
      name: "Green Haven Plant Care",
      rating: 4.8,
      distance: "0.5 miles",
      services: ["Plant Care", "Pest Control", "Consultation"],
      priceRange: "$$",
      reviews: 127,
    },
    {
      id: "2",
      name: "Urban Jungle Services",
      rating: 4.6,
      distance: "1.2 miles",
      services: ["Watering", "Repotting", "Plant Sitting"],
      priceRange: "$$$",
      reviews: 89,
    },
    {
      id: "3",
      name: "Plant Doctor Mobile",
      rating: 4.9,
      distance: "2.1 miles",
      services: ["Plant Health Check", "Disease Treatment", "Fertilization"],
      priceRange: "$$",
      reviews: 203,
    },
  ];
  ...
  const validateForm = () => {
    ...
    if (selectedDate && new Date(selectedDate) < new Date()) {
      newErrors.selectedDate = "Date cannot be in the past";
    }
      ...
      {step === "location" && (
        <div className="bg-white rounded-xl shadow-sm p-8 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-md mx-auto">
            We need your location to show nearby plant care services in your area.
          </p>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {store.services.map((service) => (
                        <span key={service} className="px-3 py-1 bg-green-100 text-green-700 text-sm rounded-full">
                          {service}
                        </span>
                      ))}
                    </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    min={getTomorrowDate()}
                    className={`w-full pl-10 pr-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4CAF50] ${
      ...
      {step === "confirmation" && (
        <div className="bg-white rounded-xl shadow-sm p-8 text-center">
          ...
          <div className="flex gap-3 max-w-md mx-auto">
            ...
            <Link
              to="/gardener"
              className="flex-1 px-6 py-3 bg-[#4CAF50] text-white rounded-lg hover:bg-[#45a049] transition-colors"
            >
              Back to Home
            </Link>
          </div>
