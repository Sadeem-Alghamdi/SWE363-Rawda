      ...
      <div className="mt-8 bg-gradient-to-r from-orange-600 to-amber-600 rounded-xl p-6 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <button className="px-4 py-3 bg-white bg-opacity-10 rounded-lg hover:bg-opacity-20 transition-all text-left">
            ...
            <p className="text-sm opacity-80 mt-1">Manage inventory</p>
          </button>
          <button className="px-4 py-3 bg-white bg-opacity-10 rounded-lg hover:bg-opacity-20 transition-all text-left">
            <p className="font-medium">Create Service</p>
            <p className="text-sm opacity-80 mt-1">Offer plant care</p>
          </button>
          <button className="px-4 py-3 bg-white bg-opacity-10 rounded-lg hover:bg-opacity-20 transition-all text-left">
            <p className="font-medium">View Requests</p>
            <p className="text-sm opacity-80 mt-1">3 pending</p>
          </button>
          <button className="px-4 py-3 bg-white bg-opacity-10 rounded-lg hover:bg-opacity-20 transition-all text-left">
            <p className="font-medium">Check Reviews</p>
            <p className="text-sm opacity-80 mt-1">156 total reviews</p>
          </button>
        </div>
      </div>
    </div>
